      ...
      <section className="relative py-32 bg-[#F8FAFB]">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <motion.div {...fadeInUp} className="text-center mt-12">
            ...
            >
              <span className="font-semibold">{t('home.recruiting.viewAll')}</span>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          <motion.div {...fadeInUp}>
            <span className="text-[#14D5C7] tracking-[0.3em] uppercase text-sm mb-6 block">
              {t('home.invisible.label')}
            </span>
            <h2 className="text-4xl md:text-6xl lg:text-7xl text-[#F8FAFB] mb-8 leading-tight">
              {t('home.invisible.title1')}<br />
              {t('home.invisible.title2')}<br />
              <span className="text-[#14D5C7]">{t('home.invisible.title3')}</span>
            </h2>
            <p className="text-[#F8FAFB]/70 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
              {t('home.invisible.description')}
            </p>
          </motion.div>
        </div>
      </section>
            ...
            {[
              {
                ...
                title: t('home.whyHanamichi.feature1.title'),
                description: t('home.whyHanamichi.feature1.desc'),
                color: 'from-blue-500 to-cyan-500'
              },
              {
                icon: <Briefcase className="text-white" size={32} />,
                title: t('home.whyHanamichi.feature2.title'),
                description: t('home.whyHanamichi.feature2.desc'),
                color: 'from-purple-500 to-pink-500'
              },
              {
                icon: <Globe className="text-white" size={32} />,
                title: t('home.whyHanamichi.feature3.title'),
                description: t('home.whyHanamichi.feature3.desc'),
                color: 'from-green-500 to-emerald-500'
              },
              {
                icon: <Award className="text-white" size={32} />,
                title: t('home.whyHanamichi.feature4.title'),
                description: t('home.whyHanamichi.feature4.desc'),
                color: 'from-orange-500 to-red-500'
              },
              {
                icon: <Users className="text-white" size={32} />,
                title: t('home.whyHanamichi.feature5.title'),
                description: t('home.whyHanamichi.feature5.desc'),
      ...
      <section className="relative py-32 bg-[#0B1020]">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="space-y-8">
            {[
              { step: '1', title: t('home.journey.step1.title'), description: t('home.journey.step1.desc'), color: 'from-[#14D5C7] to-[#14D5C7]/70' },
              { step: '2', title: t('home.journey.step2.title'), description: t('home.journey.step2.desc'), color: 'from-[#14D5C7] to-[#14D5C7]/70' },
              { step: '3', title: t('home.journey.step3.title'), description: t('home.journey.step3.desc'), color: 'from-[#14D5C7] to-[#14D5C7]/70' },
              { step: '4', title: t('home.journey.step4.title'), description: t('home.journey.step4.desc'), color: 'from-[#14D5C7] to-[#14D5C7]/70' },
              { step: '5', title: t('home.journey.step5.title'), description: t('home.journey.step5.desc'), color: 'from-[#14D5C7] to-[#14D5C7]/70' },
              { step: '6', title: t('home.journey.step6.title'), description: t('home.journey.step6.desc'), color: 'from-[#14D5C7] to-[#14D5C7]/70' },
            ].map((item, index) => (
              <motion.div
                key={index}
      ...
      <section className="relative py-32 bg-[#F8FAFB]">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <motion.div {...fadeInUp} className="mb-12">
            <h3 className="text-2xl text-[#0B1020] mb-8 text-center">{t('home.partners.subtitle')}</h3>
          ...
          <motion.div {...fadeInUp} className="group relative bg-gradient-to-br from-white via-[#F8FAFB] to-white rounded-3xl p-10 border-2 border-[#14D5C7]/30 hover:border-[#14D5C7] shadow-lg hover:shadow-2xl hover:shadow-[#14D5C7]/20 transition-all duration-500 overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="inline-block px-4 py-2 bg-gradient-to-r from-[#14D5C7]/20 to-[#14D5C7]/10 rounded-full mb-4">
                <span className="text-[#0B1020] text-sm font-semibold tracking-wide">{t('home.partners.domestic.label')}</span>
              </div>
              <h3 className="text-2xl text-[#14D5C7] mb-3 font-bold">{t('home.partners.domestic.title')}</h3>
              ...
              <p className="text-[#161616]/70 leading-relaxed">{t('home.partners.domestic.desc')}</p>
            </div>
          </motion.div>
          ...
          <motion.div {...fadeInUp} className="text-center mt-12">
            <Link
              ...
              className="inline-flex items-center space-x-3 px-10 py-5 bg-gradient-to-r from-[#0B1020] to-[#161616] text-[#F8FAFB] rounded-full hover:shadow-2xl hover:shadow-[#0B1020]/50 transition-all duration-300 hover:scale-105 border-2 border-[#0B1020] group"
            >
              <span className="font-semibold">{t('home.partners.viewAll')}</span>
              <ArrowRight className="group-hover:translate-x-2 transition-transform" size={20} />
            </Link>
          </motion.div>
        </div>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <motion.div {...fadeInUp}>
            <div className="inline-block px-6 py-3 bg-gradient-to-r from-[#14D5C7]/20 to-[#14D5C7]/10 rounded-full mb-8 border border-[#14D5C7]/30">
              <span className="text-[#14D5C7] text-sm font-semibold tracking-widest uppercase">{t('home.cta.label')}</span>
            </div>
            <h2 className="text-4xl md:text-6xl text-[#F8FAFB] mb-6 font-bold">
              {t('home.cta.title1')}<span className="text-[#14D5C7]">{t('home.cta.title2')}</span>
            </h2>
            ...
            <p className="text-[#F8FAFB]/50 text-sm mt-6">{t('home.cta.note')}</p>
          </motion.div>
        </div>
      </section>
    </div>
