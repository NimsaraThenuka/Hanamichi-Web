...
export function Contact() {
  ...
  return (
    <div className="bg-[#F8FAFB] pt-24">
      {/* Hero */}
      <PageHero
        title={<>Contact <span className="text-[#14D5C7]">Us</span></>}
        description="Let's discuss your future opportunities and educational goals."
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <motion.div {...fadeInUp} className="relative bg-gradient-to-br from-white via-white to-[#F8FAFB] rounded-3xl p-10 border-2 border-[#14D5C7]/30 shadow-xl overflow-hidden">
              ...
              <div className="relative z-10">
                <h2 className="text-3xl text-[#0B1020] mb-8 font-bold">Send us a message</h2>
                <form className="space-y-6">
                  <div>
                    <label htmlFor="name" className="block text-[#0B1020] mb-2 font-semibold">Name</label>
                    <input
                      type="text"
                      id="name"
                  ...
                  <div>
                    <label htmlFor="email" className="block text-[#0B1020] mb-2 font-semibold">Email</label>
                    <input
                      type="email"
                      id="email"
                      className="w-full px-5 py-4 bg-white border-2 border-[#14D5C7]/20 rounded-2xl focus:outline-none focus:border-[#14D5C7] focus:shadow-lg focus:shadow-[#14D5C7]/20 transition-all duration-300"
                  ...
                  <div>
                    <label htmlFor="phone" className="block text-[#0B1020] mb-2 font-semibold">Phone (Optional)</label>
                    <input
                      type="tel"
                      id="phone"
                      className="w-full px-5 py-4 bg-white border-2 border-[#14D5C7]/20 rounded-2xl focus:outline-none focus:border-[#14D5C7] focus:shadow-lg focus:shadow-[#14D5C7]/20 transition-all duration-300"
                  ...
                  <div>
                    <label htmlFor="message" className="block text-[#0B1020] mb-2 font-semibold">Message</label>
                    <textarea
                      id="message"
                      rows={6}
            ...
            <motion.div {...fadeInUp} transition={{ delay: 0.2 }}>
              <div className="bg-gradient-to-br from-white via-white to-[#F8FAFB] rounded-3xl p-10 border-2 border-[#14D5C7]/30 mb-8 shadow-xl">
                <h2 className="text-3xl text-[#0B1020] mb-8 font-bold">Get in Touch</h2>
                <div className="space-y-6">
                  <div className="group flex items-start space-x-4 p-4 rounded-2xl hover:bg-[#14D5C7]/5 transition-colors duration-300">
                    ...
                    <div>
                      <h3 className="text-[#0B1020] mb-1 font-semibold">Phone</h3>
                  ...
                  <div className="group flex items-start space-x-4 p-4 rounded-2xl hover:bg-[#14D5C7]/5 transition-colors duration-300">
                    ...
                    <div>
                      <h3 className="text-[#0B1020] mb-1 font-semibold">Email</h3>
                  ...
                  <div className="group flex items-start space-x-4 p-4 rounded-2xl hover:bg-[#14D5C7]/5 transition-colors duration-300">
                    ...
                    <div>
                      <h3 className="text-[#0B1020] mb-1 font-semibold">Address</h3>
                      <p className="text-[#161616]/70">
                        2-1-3 Nigawa Takamaru<br />
              ...
              <div className="relative bg-gradient-to-br from-[#0B1020] via-[#161616] to-[#0B1020] rounded-3xl p-10 text-center overflow-hidden shadow-2xl">
                ...
                <div className="relative z-10">
                  <div className="inline-block px-4 py-2 bg-gradient-to-r from-[#14D5C7]/20 to-[#14D5C7]/10 rounded-full mb-4 border border-[#14D5C7]/30">
                    <span className="text-[#14D5C7] text-xs font-semibold tracking-widest uppercase">Special Offer</span>
                  </div>
                  <h3 className="text-2xl text-[#F8FAFB] mb-4 font-bold">Book Your Free Consultation</h3>
                  <p className="text-[#F8FAFB]/70 mb-6 leading-relaxed">
                    The first 30 minutes are completely free. Let's explore your future together.
                  </p>
                  ...
                  <div className="text-[#14D5C7] font-semibold">First 30 minutes FREE</div>
                </div>
              </div>
            </motion.div>
          </div>
